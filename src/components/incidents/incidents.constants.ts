...
export const CGTHAOLUAN_OPTIONS: SelectOption[] = [
  { value: "0", label: "Không" },
  { value: "1", label: "Có" },
  { value: "2", label: "Không ghi nhận" },
];
...
export const CAUSES_LEFT_DEFAULT: CauseItem[] = [
  ...
  {
    causeKey: "nhiemkhuan",
    causeLabel: "Nhiễm khuẩn bệnh viện",
    defaultMaxOptions: 5,
  },
  {
    causeKey: "thuoc",
    causeLabel: "Thuốc và dịch truyền",
    defaultMaxOptions: 9,
  },
  {
    causeKey: "mau",
    causeLabel: "Máu và các chế phẩm máu",
    defaultMaxOptions: 3,
  },
  ...
  {
    causeKey: "tainan",
    causeLabel: "Tai nạn đối với người bệnh",
    defaultMaxOptions: 1,
  },
  { causeKey: "hatang", causeLabel: "Hạ tầng cơ sở", defaultMaxOptions: 2 },
  {
    causeKey: "nguonluc",
    causeLabel: "Quản lý nguồn lực, tổ chức",
    defaultMaxOptions: 3,
  },
  {
    causeKey: "tailieu",
    causeLabel: "Hồ sơ, tài liệu, thủ tục hành chính",
    defaultMaxOptions: 6,
  },
];
...
export const CAUSES_RIGHT_DEFAULT: CauseItem[] = [
  ...
  {
    causeKey: "nnnmoitruong",
    causeLabel: "Môi trường làm việc",
    defaultMaxOptions: 4,
  },
  {
    causeKey: "nnntochuc",
    causeLabel: "Tổ chức/ dịch vụ",
    defaultMaxOptions: 4,
  },
  {
    causeKey: "nnnbenngoai",
    causeLabel: "Yếu tố bên ngoài",
    defaultMaxOptions: 3,
  },
];
